...
#
# ident	"@(#)tp_compression_static_002.ksh	1.2	08/12/19 SMI"
#
...
#
# ASSERTION: compression_static_002
#
# DESCRIPTION
#	When a zero-length file is compressed via lofiadm using the default
...
#	Assert
#		- Compress the file using 'lofiadm -C'
...
#
function tp_compression_static_002 {
	typeset -r ME=$(whence -p ${0})
	zero_size_test 002 default $ME
}
