...
#
# ident	"@(#)tp_compression_static_005.ksh	1.2	08/12/19 SMI"
#
...
#
# ASSERTION: compression_static_005
#
# DESCRIPTION
#	When a zero-length file is compressed via lofiadm using the 'gzip-9'
...
#	Assert
#		- Compress the file using 'lofiadm -C gzip-9'
...
#
function tp_compression_static_005 {
	typeset -r ME=$(whence -p ${0})
	zero_size_test 005 gzip-9 $ME
}
