...
#
# ident	"@(#)tp_compression_static_004.ksh	1.2	08/12/19 SMI"
#
...
#
# ASSERTION: compression_static_004
#
# DESCRIPTION
#	When a zero-length file is compressed via lofiadm using the 'gzip-6'
...
#	Assert
#		- Compress the file using 'lofiadm -C gzip-6'
...
#
function tp_compression_static_004 {
	typeset -r ME=$(whence -p ${0})
	zero_size_test 004 gzip-6 $ME
}
