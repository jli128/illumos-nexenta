...
#
# ident	"@(#)tp_compression_static_006.ksh	1.1	09/03/09 SMI"
#
...
#
# ASSERTION: compression_static_006
#
# DESCRIPTION
#	When a zero-length file is compressed via lofiadm using the 'lzma'
...
#	Assert
#		- Compress the file using 'lofiadm -C lzma'
...
#
function tp_compression_static_006 {
	typeset -r ME=$(whence -p ${0})
	zero_size_test 006 lzma $ME
}
