...
#
# ident	"@(#)tp_sharectl_023.ksh	1.3	08/06/11 SMI"
#
...
#       Setup:
#       Test:
#               set the listen_backlog to bad values
#       Cleanup:
#               - N/A
#
#       STRATEGY_NOTES:
...
#
#__stc_assertion_end
function sharectl023 {
	tet_result PASS
	tc_id="sharectl023"
	tc_desc="Attempt to modify the listen_backlog to bad values"
	cmd_list=""
	unset GROUPS
	...
	set_ctl NEG listen_backlog nfs
	set_ctl NEG listen_backlog -1
