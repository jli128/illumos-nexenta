...
#
# ident	"@(#)tp_set_002.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set the nfs aclok property for a share group.
#
#STRATEGY:
#
#	Setup:
...
function set_002 {
	tet_result PASS
	tc_id="set_002"
	tc_desc="Set nfs aclok property for a group"
	cmd_list=""
	unset GROUPS
	...
	#
	# Set nfs aclok property.  (Dry run first then the real thing.)
	#
