...
#
# ident	"@(#)tp_set_001.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to execute 'sharemgr set' with no properties specified.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Execute sharemgr set for nfs protocol without specifying any
#		  properties.  The command should fail.
#	Cleanup:
...
function set_001 {
	tet_result PASS
	tc_id="set_001"
	tc_desc="Attempt 'sharemgr set -P nfs' with no properties specified."
	cmd_list=""
	unset GROUPS
	...
	#
	# Execute set command with no properties specified.  (Dry run
	# first then the real thing.)
	#
	set_ NEG test_group_1 -P nfs -n
	set_ NEG test_group_1 -P nfs
