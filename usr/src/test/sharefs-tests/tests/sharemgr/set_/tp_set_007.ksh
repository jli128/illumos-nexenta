...
#
# ident	"@(#)tp_set_007.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set nfs nosuid property for a share group.
#
#STRATEGY:
#
#	Setup:
...
function set_007 {
	tet_result PASS
	tc_id="set_007"
	tc_desc="Set nfs nosuid property for a group"
	cmd_list=""
	unset GROUPS
	...
	#
	# Set nosuid property.  (Dry run first then the real thing.)
	#
	set_ POS test_group_1 -P nfs -n -p nosuid=\"\"
	set_ POS test_group_1 -P nfs -p nosuid=\"\"
