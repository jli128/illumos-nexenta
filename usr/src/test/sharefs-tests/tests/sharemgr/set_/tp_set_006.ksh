...
#
# ident	"@(#)tp_set_006.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set nfs nosub property for a share group.
#
#STRATEGY:
#
#	Setup:
...
function set_006 {
	tet_result PASS
	tc_id="set_006"
	tc_desc="Set nfs nosub property for a group"
	cmd_list=""
	unset GROUPS
	...
	#
	# Set the nosub property.  (Dry run first then the real thing.)
	#
	set_ POS test_group_1 -P nfs -n -p nosub=\"\"
	set_ POS test_group_1 -P nfs -p nosub=\"\"
