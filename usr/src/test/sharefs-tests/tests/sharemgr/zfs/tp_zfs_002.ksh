...
#
# ident	"@(#)tp_zfs_002.ksh	1.4	09/08/01 SMI"
#
...
#
#       STRATEGY_NOTES:
#		Same as previous test, but change the order of the
#		sharemgr create group and the zfs share call.
#
#KEYWORDS:
#
#       zfs
...
function zfs002 {
	...
	#
	# Create the group after the share has been done.
	#
	create test_group_1
