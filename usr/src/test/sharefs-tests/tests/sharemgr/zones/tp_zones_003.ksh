...
#
# ident	"@(#)tp_zones_003.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#       Attempt a valid move but from a non-global zone.
#
#STRATEGY:
#
#       Setup:
...
#
#__stc_assertion_end
function zone_move001 {
	tet_result PASS
	tc_id="zone_move001"
	tc_desc="Attempt a valid move but from a non-global zone"
	cmd_list=""
	unset GROUPS
