...
#
# ident	"@(#)tp_disable_002.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Disable/enable specific single group with multiple shares
#
#STRATEGY:
#
#	Setup:
#		- Create first share group with default properties.
#		- Populate first group with multiple shares.
...
function disable002 {
	tet_result PASS
	tc_id="disable002"
	tc_desc="Disable/enable specific single group with multiple shares"
	cmd_list=""
	unset GROUPS
