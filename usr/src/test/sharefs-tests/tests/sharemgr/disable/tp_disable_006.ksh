...
#
# ident	"@(#)tp_disable_006.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Disable a group that's already disabled
#
#STRATEGY:
#
#	Setup:
...
function disable006 {
	tet_result PASS
	tc_id="disable006"
	tc_desc="Disable a group that's already disabled"
	cmd_list=""
	unset GROUPS
	...
	#
	# Disable ${TG[0]} again and verify the state is still 'disabled'.
