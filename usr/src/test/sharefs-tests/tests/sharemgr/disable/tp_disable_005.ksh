...
#
# ident	"@(#)tp_disable_005.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Enable a group that's already enabled
#
#STRATEGY:
#
#	Setup:
...
function disable005 {
	tet_result PASS
	tc_id="disable005"
	tc_desc="Enable a group that's already enabled"
	cmd_list=""
	unset GROUPS
	...
	# Setup
	#
	# Create and populate share group we will enable
	create ${TG[0]}
	...
	#
	# Enable test group 1 and verify the state is still 'enabled'.  (Dry
