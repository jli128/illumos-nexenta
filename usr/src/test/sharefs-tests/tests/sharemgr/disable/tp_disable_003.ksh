...
#
# ident	"@(#)tp_disable_003.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Disable/enable specific multiple groups with single share each
#
#STRATEGY:
#
#	Setup:
...
#		- Create third (control) share group with default properties.
#		- Populate third group with one share.
#	Test:
#		- Disable first and second groups with single command.
#		- Verify that third group is still enabled.
#		- Enable first and second groups with single command.
#		- Verify that third group is still enabled.
#	Cleanup:
...
function disable003 {
	tet_result PASS
	tc_id="disable003"
	tc_desc="Disable/enable specific multiple groups with single share each"
	cmd_list=""
	unset GROUPS
