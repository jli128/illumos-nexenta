...
#
# ident	"@(#)tp_create_004.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Sharemgr should not crash with bad lines in /etc/dfs/dfstab"
#
#STRATEGY:
#
#       Setup:
#		- Add a legacy share line to the /etc/dfs/dfstab with a bad
#		  description (no quotes)
#       Test:
#		- use the create command to create a group
#		- Check that the legacy share line still exists
#		- Check that sharemgr did not have any problems
#       Cleanup:
...
function create004 {
	tet_result PASS
	tc_id="create004"
	tc_desc="Sharemgr should not crash with bad lines in /etc/dfs/dfstab"
	cmd_list=""
	unset GROUPS
	...
	tet_infoline " Writing the following line with syntax error to dfstab :"
