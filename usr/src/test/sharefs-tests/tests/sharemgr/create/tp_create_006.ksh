...
#
# ident	"@(#)tp_create_006.ksh	1.3	08/06/11 SMI"
#
...
function create006 {
	tet_result PASS
	tc_id="create006"
	tc_desc="Perform create command with non-existent protocol specified."
	cmd_list=""
	unset GROUPS
	...
	#
	create NEG ${TG[0]} -n -P bogus_protocol
	create NEG ${TG[0]} -P bogus_protocol
