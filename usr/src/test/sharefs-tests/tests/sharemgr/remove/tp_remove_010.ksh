...
#
# ident	"@(#)tp_remove_010.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt a valid remove-share but with insufficient user privileges.
#
#STRATEGY:
#
#	Setup:
...
function remove010 {
	tet_result PASS
	tc_id="remove010"
	tc_desc="Attempt a valid remove-share with insufficient user priveleges"
	cmd_list=""
	unset GROUPS
	...
	#
	# Dry run is expected to pass as user privileges aren't checked.
