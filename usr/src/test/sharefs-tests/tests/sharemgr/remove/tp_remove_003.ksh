...
#
# ident	"@(#)tp_remove_003.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Remove one of several shares from an enabled share group.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Remove one share from the first share group.
...
function remove003 {
	tet_result PASS
	tc_id="remove003"
	tc_desc="Remove one of several shares from an enabled share group"
	cmd_list=""
	unset GROUPS
