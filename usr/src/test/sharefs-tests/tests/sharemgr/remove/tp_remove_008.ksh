...
#
# ident	"@(#)tp_remove_008.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt a remove without specifying a share.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to remove a share but do not provide a share name.
...
function remove008 {
	tet_result PASS
	tc_id="remove008"
	tc_desc="Attempt a remove without specifying a share"
	cmd_list=""
	unset GROUPS
	...
	#
	remove_share NEG test_group_1 "-n" ""
	remove_share NEG test_group_1 "" ""
	#
	# Cleanup
	#
