...
#
# ident	"@(#)tp_remove_006.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to remove a valid share from a non-existent share group.
#
#STRATEGY:
#
#	Setup:
...
#		  first share group) but provide a non-existent group name.
...
function remove006 {
	tet_result PASS
	tc_id="remove006"
	tc_desc="Attempt a remove a valid share from a non-existent group"
	cmd_list=""
	unset GROUPS
	...
	#
	remove_share NEG bogus_group "-n" ${MP[0]}
	remove_share NEG bogus_group "" ${MP[0]}
	#
	# Cleanup
	#
