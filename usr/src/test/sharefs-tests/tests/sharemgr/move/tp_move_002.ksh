...
#
# ident	"@(#)tp_move_002.ksh	1.3	08/06/11 SMI"
#
...
#		  shared and now has the options of the second share group.
#	Cleanup:
...
function move002 {
	tet_result PASS
	tc_id="move002"
	tc_desc="Move single share to empty group with different options"
	cmd_list=""
	unset GROUPS
	...
	create test_group_2 -P nfs -p nosuid=\"true\" -p anon=\"12345\" \
