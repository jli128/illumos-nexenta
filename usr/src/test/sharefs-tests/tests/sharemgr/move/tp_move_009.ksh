...
#
# ident	"@(#)tp_move_009.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt a move without specifying a share.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to move a share but do not provide a share name.
...
function move009 {
	tet_result PASS
	tc_id="move009"
	tc_desc="Attempt a move without specifying a share"
	cmd_list=""
	unset GROUPS
	...
	#
	move_share NEG test_group_1 "-n" ""
	move_share NEG test_group_1 "" ""
	#
	# Cleanup
	#
