...
#
# ident	"@(#)tp_move_008.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to move a valid share without specifying a target group.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to move a share but do not provide a target group
#		  name.  The operation should fail.
...
function move008 {
	tet_result PASS
	tc_id="move008"
	tc_desc="Attempt a move a valid share without specifying target group"
	cmd_list=""
	unset GROUPS
