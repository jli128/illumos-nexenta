...
#
# ident	"@(#)tp_move_007.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to move a valid share to a non-existent share group.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to move a share to a non-existent group (provide
#		  a bogus group name).  The operation should fail.
...
function move007 {
	tet_result PASS
	tc_id="move007"
	tc_desc="Attempt a move a valid share to a non-existent group"
	cmd_list=""
	unset GROUPS
	...
	#
	move_share NEG bogus_group "-n" ${MP[0]}
	move_share NEG bogus_group "" ${MP[0]}
	#
	# Cleanup
	#
