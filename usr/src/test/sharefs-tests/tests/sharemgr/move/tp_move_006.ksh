...
#
# ident	"@(#)tp_move_006.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to move a non-existent share to a new share group.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to move a non-existent share (provide a bogus path
#		  name) to the second share group.  The operation should fail.
...
function move006 {
	tet_result PASS
	tc_id="move006"
	tc_desc="Attempt to move a non-existent share to a valid group"
	cmd_list=""
	unset GROUPS
	...
	#
	move_share NEG test_group_2 "-n" bogus_path
	move_share NEG test_group_2 "" bogus_path
	#
	# Cleanup
	#
