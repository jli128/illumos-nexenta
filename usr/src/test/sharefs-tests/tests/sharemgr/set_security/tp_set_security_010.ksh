...
#
# ident	"@(#)tp_set_security_010.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to change and then unset nfs security properties.
#
#STRATEGY:
#
#	Setup:
...
#
#__stc_assertion_end
function security010 {
	tet_result PASS
	tc_id="security010"
	tc_desc="Attempt to change and then unset nfs security properties."
	cmd_list=""
	unset GROUPS
	...
	#
	# Attempt set to modify a property.  (Dry run then the real
	# thing for each command.)
	#
