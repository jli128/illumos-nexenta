...
#
# ident	"@(#)tp_delete_001.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#       Remove only share group on the system.
#
#STRATEGY:
#
#       Setup:
...
function delete001 {
	tet_result PASS
	tc_id="delete001"
	tc_desc="Remove only share group on the system"
	cmd_list=""
	unset GROUPS
	...
	create ${TG[0]}
	#
	# Delete share group.  (Dry run then real thing.)
	#
	delete POS ${TG[0]} -n
	delete POS ${TG[0]}
	#
