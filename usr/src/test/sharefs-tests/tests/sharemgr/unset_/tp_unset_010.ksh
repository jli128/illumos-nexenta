...
#
# ident	"@(#)tp_unset_010.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Attempt to unset nfs property without specifying nfs protocol.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Attempt to unset the nfs anon property without specifying
...
function unset010 {
	tet_result PASS
	tc_id="unset010"
	tc_desc="Attempt to unset nfs properties without specifying protocol."
	cmd_list=""
	unset GROUPS
	...
	# Setup
	#
	# Create share group with nfs protocol and the anon property set.
	create test_group_1 -P nfs -p anon="1234"

	#
	# Attempt to unset anon property without specifying a protocol.  This
	# should fail.  (Dry run then the real thing.)
	#
	unset_ NEG test_group_1 -n -p anon
	unset_ NEG test_group_1 -p anon
