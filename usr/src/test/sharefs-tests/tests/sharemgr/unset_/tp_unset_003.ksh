...
#
# ident	"@(#)tp_unset_003.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Unset the nfs index property.
#
#STRATEGY:
#
#	Setup:
#		- Create share group with nfs protocol and index property set.
#	Test:
#		- Unset the index property.
#	Cleanup:
...
function unset003 {
	tet_result PASS
	tc_id="unset003"
	tc_desc="Unset the nfs index property"
	cmd_list=""
	unset GROUPS
	...
	create test_group_1 -P nfs -p index=\"test_file_aaa\"

	#
	# Unset the index property.  (Dry run then the real thing.)
	#
	unset_ POS test_group_1 -n -P nfs -p index
	unset_ POS test_group_1 -P nfs -p index
