...
#
# ident	"@(#)tp_set_share_005.ksh	1.4	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Clear resource-name and description for share that has them set.
#
#STRATEGY:
#
#	Setup:
...
#
#__stc_assertion_end
function set_share005 {
	tet_result PASS
	tc_id="set_share005"
	tc_desc="Clear resource name and description for share"
	cmd_list=""
	unset GROUPS
