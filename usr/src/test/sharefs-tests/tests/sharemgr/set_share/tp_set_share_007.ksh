...
#
# ident	"@(#)tp_set_share_007.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Verify clearing description doesn't affect resource name.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Clear resource name and description for the share.
...
#
#__stc_assertion_end
function set_share007 {
	tet_result PASS
	tc_id="set_share007"
	tc_desc="Verify clearing description doesn't affect resource name"
	cmd_list=""
	unset GROUPS
	...
	#
	set_share POS ${MP[0]} "-n -d \"\""
	set_share POS ${MP[0]} "-d \"\""
	#
	# Cleanup
	#
