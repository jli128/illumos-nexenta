...
#
# ident	"@(#)tp_set_share_002.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set resource-name for share that does not currently have one.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Set the resource name for the share.
...
#
#__stc_assertion_end
function set_share002 {
	tet_result PASS
	tc_id="set_share002"
	tc_desc="Set resource name for share that does not currently have one"
	cmd_list=""
	unset GROUPS
	...
	#
	set_share POS ${MP[0]} "-n -r test_resource_name"
	set_share POS ${MP[0]} "-r test_resource_name"
	#
	# Cleanup
	#
