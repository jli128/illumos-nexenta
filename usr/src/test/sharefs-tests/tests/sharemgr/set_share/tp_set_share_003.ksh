...
#
# ident	"@(#)tp_set_share_003.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set resource-name and description for share that does not currently
#	have either.
#
#STRATEGY:
#
...
#
#__stc_assertion_end
function set_share003 {
	tet_result PASS
	tc_id="set_share003"
	tc_desc="Set resource name & description for share that has neither"
	cmd_list=""
	unset GROUPS
	...
	#
	set_share POS ${MP[0]} \
	    "-n -r test_resource_name -d \"test description\""
	set_share POS ${MP[0]} "-r test_resource_name -d \"test description\""
	#
	# Cleanup
	#
