...
#
# ident	"@(#)tp_set_share_001.ksh	1.3	08/06/11 SMI"
#
...
#DESCRIPTION:
#
#	Set description for share that does not currently have one.
#
#STRATEGY:
#
#	Setup:
...
#	Test:
#		- Set the description for the share.
...
#
#__stc_assertion_end
function set_share001 {
	tet_result PASS
	tc_id="set_share001"
	tc_desc="Set description for share that does not currently have one"
	cmd_list=""
	unset GROUPS
	...
	#
	set_share POS ${MP[0]} "-n -d \"test description\""
	set_share POS ${MP[0]} "-d \"test description\""
	#
	# Cleanup
	#
