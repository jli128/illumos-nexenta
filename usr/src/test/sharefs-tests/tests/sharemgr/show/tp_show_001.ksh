...
#
# ident	"@(#)tp_show_001.ksh	1.3	08/06/12 SMI"
#
...
#DESCRIPTION:
#
#	Execute 'show' command for multiple empty groups at one time.
#
#STRATEGY:
#
#	Setup:
...
function show001 {
	tet_result PASS
	tc_id="show001"
	tc_desc="Execute 'show' command for multiple empty groups at one time"
	cmd_list=""
	unset GROUPS
	...
	#
	show POS "test_group_1 test_group_2"
