...
#
# ident	"@(#)tc_show.ksh	1.5	08/06/11 SMI"
#
...
. ${TET_SUITE_ROOT}/sharefs-tests/tests/sharemgr/show/tp_show_001
. ${TET_SUITE_ROOT}/sharefs-tests/tests/sharemgr/show/tp_show_002
