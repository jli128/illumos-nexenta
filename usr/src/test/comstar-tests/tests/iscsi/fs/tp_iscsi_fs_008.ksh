...
#
# DESCRIPTION:
#	All the portals are belonged to the only target portal group
...
# __stc_assertion_end
#
function iscsi_fs_008
{
	cti_pass

        tc_id="iscsi_fs_008"
	tc_desc="verify I/O data validation on one target portal group of all portals"
	...
	[[ $ret -eq 0 ]] && cti_pass "tp_iscsi_fs_008: PASS"
}
