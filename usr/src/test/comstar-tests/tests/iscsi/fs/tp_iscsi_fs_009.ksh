...
#
# DESCRIPTION:
#	Target is bound with the default target portal group,
#	Running I/O data validation on one initiator host
#
# STRATEGY:
#	Setup:
...
#		All the target portals are of the default target portal group
#		Create multi target nodes (specified by TARGET_MAX variable 
#		    in configuration) with default tpgt
...
# __stc_assertion_end
#
function iscsi_fs_009
{
	cti_pass

        tc_id="iscsi_fs_009"
	tc_desc="verify I/O data validation on the default target portal group"
	...
	[[ $ret -eq 0 ]] && cti_pass "tp_iscsi_fs_009: PASS"
}
