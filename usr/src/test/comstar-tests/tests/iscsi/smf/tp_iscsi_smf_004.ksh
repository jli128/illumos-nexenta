...
#
# DESCRIPTION:
#	Verify the persistent configuration data is retained by stmf
#
# STRATEGY:
#	Setup:
#		Enable stmf smf
...
# __stc_assertion_end
#
function iscsi_smf_004
{
	cti_pass

	typeset ret_code=0
        tc_id="iscsi_smf_004"
	tc_desc="Verify the persistent configuration data is retained by stmf"
	...
	itadm_create POS tpg 2 ${portal[0]}
