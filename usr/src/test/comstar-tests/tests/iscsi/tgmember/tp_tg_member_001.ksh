...
# 
# DESCRIPTION:
# 	Add an online iscsi target node to a target group when stmf is enabled
...
# 
# __stc_assertion_end
function tgmember001 {
	cti_pass
	tc_id="tgmember001"
	tc_desc="Verify the online iscsi target can be added into target group with stmf enabled"
