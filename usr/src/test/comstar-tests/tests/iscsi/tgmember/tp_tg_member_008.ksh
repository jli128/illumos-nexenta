...
# 
# DESCRIPTION:
# 	Remove an offline iscsi target node from target group 
#	when stmf is disabled and iscsi/target is enabled
# 
# STRATEGY:
# 
# 	Setup:
...
# 
# __stc_assertion_end
function tgmember008 {
	cti_pass
	tc_id="tgmember008"
	tc_desc="Remove an offline target from target group with stmf disabled"
