...
# 
# DESCRIPTION:
# 	Add an offline iscsi target node to a target group when stmf is disabled
...
# 
# __stc_assertion_end
function tgmember003 {
	cti_pass
	tc_id="tgmember003"
	tc_desc="Verify the online iscsi target can be added into target group with stmf disabled"
