...
# 
# DESCRIPTION:
# 	Verify that add an offline iscsi target node to a target group when stmf is enabled
...
# 
# __stc_assertion_end
function tgmember004 {
	cti_pass
	tc_id="tgmember004"
	tc_desc="Verify that add the iscsi target into target group with stmf enabled"
