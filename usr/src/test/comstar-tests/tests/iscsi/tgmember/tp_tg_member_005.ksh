...
# 
# DESCRIPTION:
# 	Verify that add an offline iscsi target node to a target group when stmf is disabled
#	and iscsi/target is disabled
# 
# STRATEGY:
# 
# 	Setup:
...
# 
# __stc_assertion_end
function tgmember005 {
	cti_pass
	tc_id="tgmember005"
	tc_desc="Verify that add the iscsi target into target group with stmf disabled"
