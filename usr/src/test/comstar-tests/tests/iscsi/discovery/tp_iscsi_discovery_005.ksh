...
#
# ID: iscsi_discovery_005
#
# DESCRIPTION:
#	iSCSI target with a active target portal can register into the
#	default discovery domain of iSNS server and be visible by
#	initiator node in the same default discovery domain
#
# STRATEGY:
#	Setup:
...
# __stc_assertion_end
#
function iscsi_discovery_005
{
	cti_pass

        tc_id="iscsi_discovery_005"

	tc_desc="iSCSI target with a active target portal can register into the"
	tc_desc="${tc_desc} default discovery domain of iSNS server and be"
	tc_desc="${tc_desc} visible byinitiator node in the same default"
	tc_desc="${tc_desc} discovery domain"
