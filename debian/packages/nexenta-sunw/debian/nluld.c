...
#pragma ident	"@(#)nluld.c	1.5	05/06/08 SMI"
...
char bstr[ISTRLEN + 1]    = "/tmp/nlulib/nl.1";

#define	ISTRLEN2	12
char istr2[ISTRLEN2 + 1] = "/lib/ld.so.1";
char bstr2[ISTRLEN2 + 1] = "/tmp/nl/nl.1";
...
char b64str[I64STRLEN + 1] = "/tmp/nlulib/sparcv9/nl.1";

#define	I64STRLEN2	20
char i64str2[I64STRLEN2 + 1] = "/lib/sparcv9/ld.so.1";
char b64str2[I64STRLEN2 + 1] = "/tmp/nl/sparcv9/nl.1";
...
char b64str[I64STRLEN + 1] = "/tmp/nlulib/amd64/nl.1";

#define	I64STRLEN2	18
char i64str2[I64STRLEN2 + 1] = "/lib/amd64/ld.so.1";
char b64str2[I64STRLEN2 + 1] = "/tmp/nl/amd64/nl.1";
...
main(int argc, char **argv)
{
	...
	for (f = 1; f < argc; f++) {
		...
		close(fd);
		if (!found)
			fprintf(stderr, "nluld: %s: no ld.so.1 found\n",
			    argv[f]);
	}
	return (0);
}
